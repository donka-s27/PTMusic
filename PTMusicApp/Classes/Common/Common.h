...
#define BASE_URL                @"http://117.7.238.103:8888/mp3online-v2/index.php/api/"

#define BASE_URL_MENDY_USER         @"http://dev.myjli.com/crm/api/users/"


#define BASE_URL_MENDY_DASHBOARD @"http://dev.myjli.com/mobile-dashboard/"
#define BASE_URL_MEDY     @"http://dev.myjli.com/mp3online/index.php/api/"
#define BASE_URL_MEDY_ADS       @"http://dev.myjli.com/api/"
